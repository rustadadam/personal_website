...
const Contact: React.FC = () => {
	return (
		<section id="contact" className="py-16 bg-white dark:bg-gray-900 font-body">
			<div className="container mx-auto px-4 sm:px-8 lg:px-16">
				<SectionHeader
					title="Get In Touch"
					description="Let's connect and see how we can drive learning and innovation together."
					dividerColor="coral"
					className="mb-10"
				/>
				<motion.div
						...
						{contactMethods.map((method, idx) => {
							const CardContent = (
								<motion.div
									...
									className="flex items-center gap-4 gradient-contact-card rounded-2xl p-5 shadow-md hover:shadow-xl transition-all duration-200 cursor-pointer"
								...
								>
									...
									<div>
										<a
											...
											className="text-base font-semibold text-gray-900 dark:text-white mb-1 font-heading hover:text-coral-500 dark:hover:text-coral-400 transition-colors focus:underline"
										>
											{method.label}
										</a>
										{method.href ? (
